...
| FAT-9 | Recalibrar a faixa de variação de tamanho do gate: hoje rejeita reescritas compactas/fiéis (confirmado em produção, 0,38x o original), só aceita reescritas que crescem | aberta | 7 |
