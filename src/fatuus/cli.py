...
def format_report(result: dict, filename: str) -> str:
    lines = []
    lines.append("=" * 60)
    lines.append("  FATUUS — Relatório de Análise Sintética")
...
def main():
    parser = argparse.ArgumentParser(description="Fatuus: Desconstrução de marcas sintéticas e humanização de texto.")
