...
# Mapeamento de substituição determinística para simplificação e remoção de enchimentos
REPLACEMENTS_PT = [
...
class FatuusSanitizer:
    ...
    def deslop_text(self, text: str) -> Tuple[str, int]:
        ...
        # Normaliza múltiplos espaços decorrentes de remoções
        cleaned = re.sub(r" {2,}", " ", cleaned)
        # Corrige pontuação órfã (ex: ", ." ou " .")
