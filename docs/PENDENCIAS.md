...
| FAT-7 | Verificar a Camada 1 em produção: redeploy pós-fix de auth e smoke test com entrada que comprovadamente entre na Camada 1, guardando o JSON bruto (`layer1_attempts` ≠ 0) | aberta | 7 |
